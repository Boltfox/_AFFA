...
def main():
	...
	if setting['para']['generate_yaml'] == 'y': 
		os.chdir(confighome)
		step,al=calyaml('HTRUNll3_manager.yaml',a_min=setting['para']['a_min'],a_max=setting['para']['a_max'],dm_min=manage['dm_step'],dm_max=manage['dm_max'],t_obs=setting['para']['t_obs'])
		os.chdir(nfilpath)
